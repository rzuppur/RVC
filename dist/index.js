        ...
        return function (_ctx, _cache) {
            return (openBlock(true), createElementBlock(Fragment, null, renderList(tooltipsWithLocation.value, function (tt) {
                return (openBlock(), createElementBlock("div", {
                    "class": normalizeClass(["r-tooltip", { active: tt.active, left: tt.modifiers.left, right: tt.modifiers.right, bottom: tt.modifiers.bottom }]),
                    key: tt.id,
